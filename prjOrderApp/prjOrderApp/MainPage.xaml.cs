...
namespace prjOrderApp
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            list.Add(new C票券() { 場次 = "奇異博士", 座位 = "8E", 日期 = "2022/06/05 12:00",
                票券編號 = 1, 票種 = "敬老票", 概要 = "一個外科醫師的故事", 尚未訂票 = true, EN= "Dr. Strange 1",
                urlIma = "https://upload.wikimedia.org/wikipedia/zh/8/8d/Doctor_Strange_2016_Poster.jpg"});
            list.Add(new C票券() { 場次 = "鋼鐵人Ⅱ", 座位 = "9C", 日期 = "2022/06/06 13:00", 
                票券編號 = 2, 票種 = "學生票", 概要= "失意的東尼史塔克！",
                尚未訂票 = true, EN= "Iron Man 2",
                urlIma = "https://char.tw/wp-content/uploads/2017/08/1503017756-aabe0dc8f74b52800c15bda357fe04d9.jpg"});
            list.Add(new C票券() { 場次 = "復仇者聯盟Ⅲ", 座位 = "5D", 日期 = "2022/06/07 08:30", 
                票券編號 = 3, 票種 = "一般票", 概要= "無限之戰",尚未訂票 = true,EN= "Avengers 3",
            ...
            list.Add(new C票券() { 場次 = "鋼鐵人Ⅲ", 座位 = "13F", 日期 = "2022/06/09 13:00", 
                票券編號 = 5, 票種 = "特惠票", 概要= "覺醒的東尼史塔克！",
                尚未訂票 = true,EN= "Iron Man 3",
