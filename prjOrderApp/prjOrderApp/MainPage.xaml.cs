    ...
    public partial class MainPage : ContentPage
    {
        ...
        private void LoadDate()
        {
            list.Add(new C票券() { 場次 = "奇異博士Ⅱ", 座位 = "8E", 日期 = "2022/06/05 12:00:00",
                票券編號 = 1, 票種 = "敬老票", 概要 = "失控的多元宇宙", 尚未訂票 = true,
        ...
        public void ReserveTicket(int i)
        {
            list已訂票.Add(list[i]);
            list.RemoveAt(i);
            SetNumOfTickets();
